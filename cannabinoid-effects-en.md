...
This leads to a chronic imbalance of dopamine levels between the mesolimbic system and prefrontal cortex which is exactly what the dopamine hypothesis postulates.<sup>[</sup>[^schizo-role-dopamine]<sup>]</sup> The combination of a underlying dopmine deficiency[^adhd-sugar] in the [prefontal cortex][wiki:prefrontal-cortex]* (nucleus accumbens)* in persons with ADHD leads to a much higher risk of developing drug induced psychoses such as schizophrenia.
...
NzgwNjk3MjMsLTk1NjYzODU0LDk3ODA3NzgwNiwxOTcwMzEzOD
